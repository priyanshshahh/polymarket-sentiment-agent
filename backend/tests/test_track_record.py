...
from app.models import MarketResolution, PredictionRecord, Trade
...
def test_paid_rationale_carries_provenance_and_receipt(client, filled_trade):
    body = client.get(f"/api/trade/{filled_trade}/rationale").json()
